...
class TestCodeGenerator {
	...
	void testDivisioni() throws FileNotFoundException, SyntacticException {
		...
		assertEquals(cgVisit.getLog(), "");
		assertEquals(cgVisit.getCodiceGenerato(), "0 sa 1 sa 6 sb  1.0 6 / la lb / + sc la p P lb p P lc p P");
	}
	...
	void testGenerale() throws FileNotFoundException, SyntacticException {
		...
		assertEquals(cgVisit.getLog(), "");
		assertEquals(cgVisit.getCodiceGenerato(), "5 3 + sa la 0.5 + sb la p P 4 sb  lb p P lb 1 - sc lb sc lc p P");
	}
